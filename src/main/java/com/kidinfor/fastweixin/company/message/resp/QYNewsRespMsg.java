package com.kidinfor.fastweixin.company.message.resp;

import java.util.ArrayList;
import java.util.List;

import com.kidinfor.fastweixin.company.message.QYArticle;
import com.kidinfor.fastweixin.message.Article;
import com.kidinfor.fastweixin.message.RespType;
import com.kidinfor.fastweixin.message.util.MessageBuilder;
