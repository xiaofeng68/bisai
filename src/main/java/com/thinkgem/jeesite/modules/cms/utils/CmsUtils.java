...
public class CmsUtils {
	 ...
	 * @param siteId 站点编号
	 */
	public static List<Category> getMainNavList(String siteId,String parentId){
	    String key = "mainNavList_"+siteId+"_"+parentId;
		@SuppressWarnings("unchecked")
		List<Category> mainNavList = (List<Category>)CacheUtils.get(CMS_CACHE, key);
		if (mainNavList == null){
			...
			CacheUtils.put(CMS_CACHE, key, mainNavList);
		}
		return mainNavList;
	}
