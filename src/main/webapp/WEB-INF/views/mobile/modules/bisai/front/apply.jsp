...
<head>
	...
	<script type="text/javascript">
		...
		function addOrgItems(input,cls){
			var name = $("#"+input).val();
			...
			<form action="${ctx }/${frontPath}apply_s${urlSuffix}" method="post" onsubmit="return resetValue()">
				<ul>
					<li>
						...
						<input class="textll" type="text" name="name" id="name" placeholder="请输入比赛名称">
					</li>
					<li>
						<span class="namell">报名时间</span>
						<input class="textll" type="text" name="regstarttime" id="regstarttime" placeholder="报名时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});">
					</li>
					<li>
						<span class="namell">比赛时间</span>
						<input class="apply_input1" name="starttime" id="starttime" type="text" placeholder="开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});">
						<span class="apply_text">至</span>
						<input class="apply_input1" name="endtime" id="endtime" type="text" placeholder="结束时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});">
					</li>
					<li class="clearfix">
						...
						<span class="fl clearfix apply_address v-m">
							...
							<input class="apply_input" name="address" id="address" type="text" placeholder="请选择">
					...
					<li>
						...
						<input class="textll" type="text" name="detailAddress" placeholder="XX街道">
					</li>
					<li class="clearfix">
						<span class="namell">主办单位</span>
						<input class="textll1" id="addOrg" type="text" placeholder="请输入主办单位">
						<input type="hidden" name="orgs" id="orgs"/>
						<span class="apply_butt" onclick="addOrgItems('addOrg','orgsdic')">+</span>  
					...
					<li class="clearfix">&nbsp;&nbsp;
						...
						<input name="contractor" type="hidden" id="contractor"/>
						<span class="apply_butt" onclick="addOrgItems('addContractor','contractordic')">+</span>
					...
					<li class="clearfix">
						...
						<input type="hidden" name="sponsors" id="sponsors"/>
						<span class="apply_butt" onclick="addOrgItems('addSponsor','sponsordic')">+</span>
					...
					<li>
						...
						<input class="textll" type="text" name="contacts" id="contacts" placeholder="请输入联系人姓名">
					</li>
					
					<li>
						<span class="namell">联系号码</span>
						<input class="textll" type="text" name="phone" id="phone" placeholder="请输入联系号码">
					</li>
				</ul>
