...
<head>
    ...
    <script type="text/javascript">
        ...
        function addPeopleNote(typeid, div,num) {
            ...
            $.post('${ctxf }${frontPath}/match/savePeopleNote', {
        ...
        function updateState(id, state) {
            $.post('${ctxf }${frontPath}/match/updatePeopleNote', {
                id: id,
                state: state
            }, function (result) {
                if (result.success) {
        ...
        function deletePeopleNote(id) {
            $.post('${ctxf }${frontPath}/match/deletePeopleNote', {
                id: id
            }, function (result) {
                if (result.success) {
                    window.location.reload();
        ...
        function addOrgNote(div) {
            ...
            var user = $("#user").val();
            var phone = $("#phone").val();
            $.post('${ctxf }${frontPath}/match/saveOrgNote', {
            	id:id,
                name: name,
                user: user,
                phone: phone,
        ...
        function updateOrgState(id, state) {
            $.post('${ctxf }${frontPath}/match/updateOrgNote', {
                id: id,
                state: state
            }, function (result) {
                if (result.success) {
...
<section>
    ...
    <div class="activ_list">
        ...
        <a href="${ctx }/bisai/match/term-${match.id}-${type}${urlSuffix}">
            <div class="acti_buttom">分组抽签</div>
        </a>
        <a href="${ctx }/bisai/match/closeMatch${urlSuffix}?id=${match.id}"">
