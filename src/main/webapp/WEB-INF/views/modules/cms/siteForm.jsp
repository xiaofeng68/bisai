	...
	<form:form id="inputForm" modelAttribute="site" action="${ctx}/cms/site/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">实例如：/WEB-INF/views/modules/cms/front/themes/jeesite</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">站长统计:</label>
			<div class="controls">
				<form:textarea path="statisticsCode" htmlEscape="false" rows="4" maxlength="200" class="input-xxlarge"/>
			</div>
		</div>
