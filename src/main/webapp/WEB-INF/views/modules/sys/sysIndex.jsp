...
<html>
<head>
	<title>${fns:getSettingContent('systemName')}</title>
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="productName">${fns:getSettingContent('systemName')}</span></div>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getSettingContent('copyright')} ${fns:getSettingContent('systemName')} - Powered By <a href="${fns:getSettingContent('poweredSite')}" target="_blank">${fns:getSettingContent('poweredName')}</a> ${fns:getSettingContent('systemVersion')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
