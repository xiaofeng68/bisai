...
<html>
<head>
	<title>${fns:getSettingContent('systemName')} 登录</title>
...
<body>
	...
	<%-- <h1 class="form-signin-heading">${fns:getSettingContent('systemName')}</h1> --%>
	...
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getSettingContent('systemName')}</a> - Powered By <a href="http://jeesite.com" target="_blank">JeeSite</a> ${fns:getConfig('version')}
	</div>
